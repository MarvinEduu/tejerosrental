        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="progress" style="height: 30px;">
                    <div class="progress-bar bg-danger" role="progressbar" style="width: <?php echo $progressWidth === '0' ? '100' : '0'; ?>%;" aria-valuenow="<?php echo $progressWidth === '0' ? '100' : '0'; ?>" aria-valuemin="0" aria-valuemax="100">Not Verified</div>
